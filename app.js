...
var addButton=document.getElementsByTagName("task__button_add");//first button
...
var createNewTaskElement=function(taskString){
  ...
  var checkBox=document.createElement("input");//checkbox
    //label
  var label=document.createElement("task__label");//label
    //input (text)
...
var addTask=function(){
  console.log("Add Task...");
    //Create a new list item with the text from the #add__task-input:
